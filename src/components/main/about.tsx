  ...
  return (
   <div className="flex flex-col justify-center items-center">
    ...
    <div className="grid gap-2 mb-[20px] grid-cols-2 sm:grid-cols-3">
        ...
        <CustomCard text="Resume" gradient={gradient} onClick={() => window.open("https://drive.google.com/file/d/1KW17aI28nyc9BhZdoKYW2oSSlfsLcZk9/view?usp=sharing", "_blank")} isActive={activeSection === "resume"}/>
    </div>
